      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Stack w="1/2" gap={4}>
          ...
          <Field label="Имя пользователя" invalid={!!errors.nickname}>
            <Controller
              ...
              render={({ field }) => <Input {...field} placeholder="Заполните поле" />}
            />
          </Field>
          <Field label="О себе">
            <Controller
        ...
        <Stack w="1/2" gap={4}>
          ...
          <Field
            ...
            invalid={currentTzVariant === ETzVariant.OWN && !watch('timezoneOffset')}
          >
            <Controller
              name="timezoneOffset"
              control={control}
              render={({ field }) => (
                <TimesonesList value={field.value} onChange={field.onChange} />
              )}
            />
          </Field>
          ...
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <TimezoneRadioGroup value={field.value} onChange={field.onChange} />
            )}
          />
        </Stack>
