...
export const addLocation = (
  ...
  ajax<UUID>('/api/locations', prepareAjax({ name, address, description, city, map_link }, POST));
...
export const getMyProfile: () => Promise<IApiResponse<IApiProfile> | null> = async (
  isSoft = false,
) => {
  const res = await ajax<IApiProfile>(`/api/profile/my`, undefined, undefined, isSoft);
