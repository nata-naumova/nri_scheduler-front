...
export interface IPasswordInputProps extends InputProps, IPasswordVisibilityProps {
...
export const PasswordStrengthMeter = forwardRef<HTMLDivElement, IPasswordStrengthMeterProps>(
